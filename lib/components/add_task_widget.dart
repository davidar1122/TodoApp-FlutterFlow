...
class _AddTaskWidgetState extends State<AddTaskWidget> {
  ...
  void initState() {
    ...
    _model.tittleTextController ??= TextEditingController();
    _model.tittleFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  width: double.infinity,
                  child: TextFormField(
                    controller: _model.tittleTextController,
                    focusNode: _model.tittleFocusNode,
                    autofocus: false,
                    obscureText: false,
                    ...
                    validator: _model.tittleTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Container(
                    ...
                    await TasksRecord.collection
                        ...
                        .set(createTasksRecordData(
                          title: valueOrDefault<String>(
                            _model.tittleTextController.text,
                            'title',
                          ),
                          details: _model.detailsTextController.text,
                          completed: false,
                          user: currentUserReference,
                          cretaed: getCurrentTimestamp,
                        ));
                    Navigator.pop(context);
                  },
                  text: 'Add Task',
